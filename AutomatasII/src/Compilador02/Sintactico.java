	...
	public void analisis() {
		...
		while(iniciador<cant){
			...
			if(Lexico.tokenAnalizados.get(iniciador).getTipo().equals("Simbolo"))
			{
				...
				else if(Lexico.tokenAnalizados.get(iniciador).getValor().equals("=") && !Lexico.tokenAnalizados.get(iniciador+3).getValor().equals("{") || Lexico.tokenAnalizados.get(iniciador).getValor().equals("Identificador"))
				{
					System.out.println(Lexico.tokenAnalizados.get(iniciador+3).getValor());
					if(Lexico.tokenAnalizados.get(iniciador-1).getTipo().equals("Identificador"))
					{
			...
			if(Lexico.tokenAnalizados.get(iniciador).getTipo().equals("Constantes"))
			{
				...
				{
					if(!Lexico.tokenAnalizados.get(iniciador+1).getValor().equals(";") && !Lexico.tokenAnalizados.get(iniciador+1).getValor().equals(")") )
					{
